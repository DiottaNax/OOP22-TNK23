 ...
 * The interface extends the {@link GameEventListener} interface, allowing it to receive and handle world events.
 */
public interface GameLoop extends GameEventListener {
